...
import { addFloor, updateFloor} from '../../redux/reducers/CommonSlice'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        ...
        if(editData){
          ...
          makeApiCall(updateFloor(userData))
        }else{
          makeApiCall(addFloor(formData))
        }
      } catch (err) {
      ...
      <div className="dashboard-main-body">
        <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
          ...
          <ul className="d-flex align-items-center gap-2">
             <Link to='/floor' className="fw-medium btn btn-primary">Back</Link>
          </ul>
        </div>
