...
import { addRole, updateRole} from '../../redux/reducers/CommonSlice'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        ...
        if(editData){
          ...
          makeApiCall(updateRole(userData))
        }else{
          makeApiCall(addRole(formData))
        }
      } catch (err) {
      ...
      <div className="dashboard-main-body">
        <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
          ...
          <ul className="d-flex align-items-center gap-2">
             <Link to='/role' className="fw-medium btn btn-primary">Back</Link>
          </ul>
        </div>
                ...
                <div className="row formStyle">
                   <div className="col-md-6">
                      <div className="form-group">
                          <label htmlFor="clientName">Role Name</label>
                          <input 
                             type="text" 
